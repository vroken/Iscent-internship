...
<main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('home/assets/img/about-header.jpg');">
    ...
    <section id="why-us mb-5" class="why-us">
        <div class="container" data-aos="fade-up">
    ...
    <section id="call-to-action mt-5" class="call-to-action">
      <div class="container" data-aos="fade-up">
